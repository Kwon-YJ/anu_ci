...
def archieve():
    ...
    try:
        ...
        cur.execute("SELECT idx,species,time,IP,client_name FROM detect_information WHERE IP="+"'"+IP+"'"+"and client_name="+"'"+port+"'")
        res = cur.fetchall()
        length = len(res)
        cur.execute("SELECT IP,species,time FROM detect_information WHERE IP="+"'"+IP+"'"+"and client_name="+"'"+port+"'"+" ORDER By idx DESC LIMIT %s OFFSET %s",(limit,offset))
        data_list=cur.fetchall()
        cur.execute("SELECT COUNT(idx) FROM detect_information WHERE IP="+"'"+IP+"'"+"and client_name="+"'"+port+"'")
        total=cur.fetchall()
        cur.execute("SELECT COUNT(idx) FROM detect_information WHERE IP="+"'"+IP+"'"+"and client_name="+"'"+port+"'"+"and species like"+'"%'+"apis%"+'"')
        apis=cur.fetchall()
        cur.execute("SELECT COUNT(idx) FROM detect_information WHERE IP="+"'"+IP+"'"+"and client_name="+"'"+port+"'"+"and species like"+'"%'+"black%"+'"')
        black=cur.fetchall()
        cur.execute("SELECT COUNT(idx) FROM detect_information WHERE IP="+"'"+IP+"'"+"and client_name="+"'"+port+"'"+"and species like"+'"%'+"simil%"+'"')
        simil=cur.fetchall()
        cur.execute("SELECT COUNT(idx) FROM detect_information WHERE IP="+"'"+IP+"'"+"and client_name="+"'"+port+"'"+"and species like"+'"%'+"crabro%"+'"')
        crabro=cur.fetchall()
        cur.execute("SELECT COUNT(idx) FROM detect_information WHERE IP="+"'"+IP+"'"+"and client_name="+"'"+port+"'"+"and species like"+'"%'+"ggoma%"+'"')
        ggoma=cur.fetchall()
        cur.execute("SELECT COUNT(idx) FROM detect_information WHERE IP="+"'"+IP+"'"+"and client_name="+"'"+port+"'"+"and species like"+'"%'+"jangsu%"+'"')
        jangsu=cur.fetchall()
        db.commit()
