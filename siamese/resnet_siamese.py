...
jangsu1 = get_preproc_img('/home/cilab5/anu_ci/siamese/jangsu0000.jpg')

jangsu2 = get_preproc_img('/home/cilab5/anu_ci/siamese/jangsu0012.jpg')

ggoma1 = get_preproc_img('/home/cilab5/anu_ci/siamese/ggoma0001.jpg')

ggoma2 = get_preproc_img('/home/cilab5/anu_ci/siamese/ggoma0011.jpg')


predictions = facemodel.predict([jangsu1, jangsu1])
print('jangsu1 vs jangsu1: ', predictions[0][0])

predictions = facemodel.predict([jangsu1, jangsu2])
print('jangsu1 vs jangsu2: ', predictions[0][0])

predictions = facemodel.predict([jangsu1, ggoma1])
print('jangsu1 vs ggoma1: ', predictions[0][0])

predictions = facemodel.predict([jangsu1, ggoma2])
print('jangsu1 vs ggoma2: ', predictions[0][0])

predictions = facemodel.predict([ggoma1, ggoma1])
print('ggoma1 vs ggoma1: ', predictions[0][0])

predictions = facemodel.predict([ggoma1, ggoma2])
print('ggoma1 vs ggoma2: ', predictions[0][0])
